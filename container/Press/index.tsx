...
export default function PressContainer() {
  const images = [{ file: BusinessDay, link: "https://businessday.ng/news/article/scholarx-partners-airtel-to-launch-mobile-learning-platform/" }, { file: Disrupt, link: "https://disrupt-africa.com/2021/04/13/nigerian-ed-tech-startup-scholarx-partners-airtel-to-launch-mobile-learning-platform/" }, { file: GSMA, link: "https://www.gsma.com/mobilefordevelopment/m/scholarx/" }, { file: BBC, link: "https://www.bbc.com/yoruba/afrika-59752447" }, { file: TechCabal, link: "https://techcabal.com/2021/10/19/learnam-wants-to-provide-digital-literacy-for-africans/" }]
  const mapImages = images.map((image, i) => {
    return <Stack width={"100px"} alignItems="center" key={i}><a href={image.link} target="_blank"><Image src={image.file} /></a></Stack>
  })
  return (
